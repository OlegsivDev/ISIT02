...
//        shop.printAllProducts();
        ...
        shop.printAllProductsInStorage();
        shop.printAllProductsInDisplay();
        System.out.println("Shop income: " + shop.getIncome());


//        shop.addProduct(new Product("Milk Babaevskoe", "Voronezh Milk Zavod", Generator.getCurrentDate(), Generator.getRandomDate(), 10, 100));
//        shop.takeProductByName("Milk Babaevskoe", 50);
    }
    ...
    TODO: Список задач
       ...
       +5. Дабавить событие покупка товара покупателем
        6. Добавить событие установка скидки на товар
     */
}